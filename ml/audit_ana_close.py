...
────────────────────────────────────────────────────────────
★★★ 実測（2026-09-06・ウォークフォワード）—— **2枝とも潰れた**
────────────────────────────────────────────────────────────

■ ゲート1: 4帯とも通過 ／ ★陽性対照: 三連複BOX上位4 = (181)(182)の81.9%を再現して立った

■ ★★枝A: ◇**12-20倍のマス** → ★**閉じる**
| 年 | 2016 | 2017 | 2018 | 2019 | 2020 | 2021 | 2022 | 2023 | 2024 | 2025 | 2026 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| ROI% | 84.6 | 88.5 | 80.7 | 82.7 | 84.4 | 87.9 | 82.7 | 80.5 | 83.7 | 89.5 | 90.3 |
★**100%超の年 0/11**（**最良の年でも90.3%**）→ **事前登録の判定条件（半数以上）を満たさず閉じる**。

■ ★★★**全9帯が 0/11 だった**
| 帯 | 1.5-3 | 3-5 | 5-8 | 8-12 | **12-20** | 20-35 | 35-60 | 60-120 | 120倍〜 |
|---|---|---|---|---|---|---|---|---|---|
| ROI | 89.6 | 83.1 | 80.5 | 82.9 | **84.9** | 81.8 | 78.2 | 73.6 | 58.8 |
| **100%超の年** | **0/11** | **0/11** | **0/11** | **0/11** | **0/11** | **0/11** | **0/11** | **0/11** | **0/11** |
★★**11年 × 9帯 = 99マスで、100%を超えた年が1つもない**。

■ ★★★枝B: **穴の優位に「レース単位の構造」があるか** → ★★**無い**
　**12-20倍・15,457レース・帰無はレースの群ラベルを無作為に並べ替え1,000回・maxT**
　★**帰無99%点 = 15.96円**
| 次元 | 群数 | 群間の最大差 | 判定 |
|---|---|---|---|
| 頭数 | 3 | 4.48円 | ⚠検出できない |
...
| 芝ダ | 2 | 2.81円 | ⚠検出できない |
| クラス | 2 | 1.52円 | ⚠検出できない |
| ★**荒れ度(市場エントロピー)** | 3 | 4.08円 | ⚠検出できない |
| ★**(112)軸の複勝E** | 3 | 3.18円 | ⚠検出できない |
★★★**6次元とも超えない**＝**穴の優位はレースによって変わらない**＝
　**どんな選別規則も原理的に作れない**。
