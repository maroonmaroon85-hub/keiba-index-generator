...
────────────────────────────────────────────────────────────
★★★★ 実測（2026-09-06）—— **裾の幅: 上位1%のレースが払戻の81% / 2019年を除くと94.3%**
────────────────────────────────────────────────────────────

■ ゲート1 ／ ゲート板 0.8009 ／ 陽性対照 BOX4 81.9% ／
　★★内部対照（決定的）: **三連単 ROI = 103.1%** → 再現 ／ **ゲート2は4腕とも±0.6pt以内**

■ ★★★①**裾の幅**（**全払戻に占める割合・29,437レース中**）
| 腕 | 的中率 | 的中数 | ★**上位1%のレース** | 上位5% | 上位10% | ★**平均÷中央値** |
|---|---|---|---|---|---|---|
| 複勝 | 45.44% | 13,376 | **8.8%** | 28.0% | 43.5% | **1.34倍** |
| 馬連 | 11.38% | 3,349 | 34.3% | 74.1% | 96.7% | 1.52倍 |
| 三連複 | 7.13% | 2,100 | 44.2% | 90.7% | 100.0% | 1.54倍 |
| ⚠**三連単** | 2.63% | **774** | ⚠⚠**80.9%** | ⚠**100.0%** | 100.0% | ⚠⚠**2.29倍** |
★★★**三連単は全レースの上位1%（294レース）だけで払戻の81%**。
　⚠**上位5%で100%＝残り95%のレースは実質ゼロ**。**1回配当も平均7,840円 vs 中央値3,430円**。
...
　（**複勝は 89〜96% で11年とも100%未満＝連続マイナス11年**。★**安定して負ける**）

■ ★★★③**時間軸**（**「もし実測ROIが真の期待値なら」という条件付き**）
| 腕 | 1年 | 5年 | ★**20年** | 20年の投資 | 20年・中央の収支 | ⚠**20年・悪い方5%** |
|---|---|---|---|---|---|---|
| 複勝 | 0.1% | 0.0% | ⚠**0.0%** | 535万 | −45.7万 | −50.9万 |
| 馬連 | 11.3% | 0.5% | ⚠**0.0%** | 535万 | −53.9万 | −69.5万 |
| 三連複 | 19.1% | 2.9% | ⚠**0.0%** | 535万 | −47.5万 | −67.8万 |
| ★**三連単** | **48.8%** | **58.6%** | ★**67.8%** | **1,070万** | ★**+29.6万** | ⚠⚠**−74.4万** |
★★**期待値が103.1%で正しくても、20年で3回に1回は負け越す**。
　⚠**悪い方の5%では20年で74万円のマイナス**。★**中央の収支は1,070万に対し+29.6万**。
★**複勝・馬連・三連複は20年でプラスになる確率が0.0%**＝**確実に負ける**。

■ ★★結論（**判定ではない・意思決定の材料**）
| ★**「あり」と言える面** | ⚠**「なし」と言える面** |
|---|---|
| **期待値の点推定は103.1%で、裾も期待値の一部**（★**利用者の指摘は正しい**） | **103.1%は(190)の42マスの最大値**。**選ばれた理由が裾なら、それは運** |
| **モデルの腕前は本物**（的中率1.101倍・有意・(197)(198)） | ⚠⚠**2019年を除くと94.3%** |
| **「超えていない証拠」も無い** | **20年で1,070万投じて中央+29.6万、3回に1回は負け** |
★**判断は統計ではなく資金と時間の問題**。⚠**私が言えるのは「100%超の証拠は無い」まで**。
★★**ただし複勝との対比は明確**: **複勝は20年でプラスになる確率0.0%＝確実に負ける。
　三連単は「わからない」**。★**この2つは質的に違う**。

■ ⚠**この測定でも直しきれないもの**
　⚠⚠**選択バイアス（(190)の42マスの最大値）はブートストラップでは直らない**。
　★**2019年の184%が「その選択の理由そのもの」である可能性が高い**。
