...
────────────────────────────────────────────────────────────
★★★ 実測（2026-09-06・ウォークフォワード・板ベース）—— **27マス中0マス**
────────────────────────────────────────────────────────────

■ ゲート1: 4帯とも通過 ／ ゲート板: 復元R **0.8009** ／ 陽性対照: BOX4 **81.9%** → 全部立った
■ ★★内部対照: **「1着」が(185)の11マスすべてを±2pt以内に再現** → ★**装置は同一**

■ ★★★主判定: **限界ROI（軸の位置ごと）**（27比較・α=0.01/27・z=3.560）
| k | 点数 | 馬単 軸1着 | 馬単 ★軸2着 |
|---|---|---|---|
| 1 | 1 | 84.2% [72,96] | 82.5% [73,92] |
| 2 | 1 | **93.1%** [77,109] | 88.0% [75,101] |
| 3 | 1 | 85.8% [68,103] | 89.1% [71,107] |
| 4 | 1 | 86.9% [67,107] | 82.5% [60,105] |
| 5 | 1 | 89.4% [65,114] | 69.0% [47,91] |
| 6 | 1 | 67.9% [40,96] | 77.7% [47,108] |

| k | 点数 | 三連単 軸1着 | 三連単 ★軸2着 | 三連単 ★軸3着 |
|---|---|---|---|---|
| 2 | 2 | 89.9% [68,112] | 86.3% [69,104] | 75.4% [62,89] |
| 3 | 4 | **91.0%** [72,110] | 86.2% [68,105] | 68.9% [57,81] |
| 4 | 6 | 86.2% [67,106] | 85.0% [65,105] | 75.6% [58,93] |
| 5 | 8 | 83.6% [63,104] | 75.8% [57,95] | 77.5% [59,96] |
| 6 | 10 | 72.0% [47,98] | 79.8% [55,104] | 85.7% [56,115] |
★**27比較すべてで99%CI下端が100%未満（0マス）**。

■ ★★★**記述がこの測定の本体 — 事前登録の予想が当たり、しかもそれ以上だった**
| 券種 | 軸の位置 | **的中率** | **的中時の平均配当** | **限界ROI(平均)** |
|---|---|---|---|---|
...
★**「穴は勝つより絡むほうが起きやすい」は数字で出た**（**的中率 1.39 → 1.76 → 1.84%**）。
★★**だが配当がそれを打ち消し、しかも打ち消しすぎる**（**6,077 → 4,617 → 4,161円**）。
→ ★★★**穴を後ろに置くほどROIが下がる**（84.6 → 81.5 / 84.6 → 82.6 → **76.6%**）。
　**市場は「穴が絡む」ほうをむしろ過剰に織り込んでいて、1着固定のほうがまだマシ**。
⚠**事前登録では「打ち消し合って横並びになる」と予想したが、実際は打ち消しすぎた**。
　★**予想より悪い方向に外れた**（判定基準24: **類推は当たらない**）。

■ ★★結論
　★**穴をどこに置いても、紐を1頭足す増分は常に損**。
　★**(182)(185)の「組を買うこと自体が損」は、置き位置を変えても保つ**。
