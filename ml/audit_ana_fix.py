...
■ ★★★**結果（実測済み・2026-09-07）**
　★内部対照 **L=1・複勝 95.9% / 6,337R** → **再現**。
　1. 水準: **1,356本 / 年約123本 / 1日1.2本**、**ROI 102.1%**（se 5.81pt）、
　　 99%CI **[85.8, 118.4]**、ブートストラップ [87.4, 117.8]、★**100%超の割合 63.9%**。
　　 軸 **平均21.4倍 / 中央15.9倍 / 平均6.7番人気 / 的中率23.4%** → ★**穴側に寄っている**。
　2. 対照: 乱 80.9%、★**対応差 +21.2円**、99%CI **[+1.9, +40.6]** → ★**0を含まない**。
　3. 年別: 93/102/102/110/122/119/72/117/93/140/72% → **7/11年が100%超**。
　　 **前半101.9%（1,038本） / 後半102.9%（318本）** → ★**縮んでいない**。
　4. 裾: 上位1% **10.7%** / 上位5% **37.0%**、1回配当 平均437円・中央380円
　　 → **平均÷中央 1.15倍** → ★**裾に頼っていない**。
　5. ★★★**必要標本 79,329本（現在の58.5倍）= 年123本で ★644年**。

■ ★★★**結論**
　★**「対照より良い」は確認できた**（対応差の99%CIが0を含まない）。
　⚠**「100%を超える」は確認できないし、今後も確認できない**（644年）。
　★**残るのは「確認できないが対照より良い」を受け入れるかどうかの判断だけ**。
　⚠**本数を増やす方向（ズレ床を下げる）は探さない**:
　　(203)で**帯ごとの対応差が単調**（+5.8円→+17.9円）と測定済みで、
　　★**床を下げれば1本あたりの優位が下がり、need∝s²/(ROI-100)² より必要本数は増える**。
　　さらに**それ自体が新しい選択操作**で、(201)は縮み25.8pt、(209)は165.1%→67.7%を実測。
