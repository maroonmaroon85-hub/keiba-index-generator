...
#   　**①②③④とも推奨に入った**。
#
#   ■ ⚠★**落とす理由を取り違えないこと（★2026-09-19 に一度取り違えた）**
#   　⚠**「確定オッズには結果が入っている」は★誤り**。**パリミュチュエルは締切で投票が止まる**
#   　　ので、**確定単勝オッズに結果は入っていない**。
#   　★**複勝の板も実測で確認した**——**発走済み6レースでも `[下限,上限]` の幅が残っており、
#   　　着内3頭の払戻に潰れていない**（**lo==hi は発走済み0〜1頭・未発走にも0〜1頭いる＝
#   　　単に断然人気が 1.0-1.0 になっているだけ**）。→ ★**板から着順は読めない**。
#   　→ ★★**複勝の的中率そのものは歪まない**。
#
#   ■ ★**それでも落とす理由は2つ**
#   　**1.** ★**買えない**。**11:00発走を11:05に推奨しても執行できない**。
#   　　　**台帳に載せると「買っていない買い目」が混じる**。
#   　**2.** ★**情報集合が違う**。**確定オッズでの選択は「締切直前の規則」であって
#   　　　「朝9時の規則」ではない**。**(219): 人気1番の一致は朝9時73.3% → 締切98.3%**。
#   　　　→ ⚠**混ぜると、2つの時点の規則が1つの標本に同居する**。
#   　★**確定オッズ版の母集団は11年の凍結値（複勝23.4%）そのもの**——**別の標本**。
#
