...
────────────────────────────────────────────────────────────
★★★ 実測（2026-09-06）—— **2026-06-26〜07-26・224レース**
────────────────────────────────────────────────────────────
| 腕 | 点数/R | 買った額 | 払戻 | ★**収支** | ★**ROI** | 的中 | 11年のROI | 差 |
|---|---|---|---|---|---|---|---|---|
| ★**複勝** | 1 | 22,400円 | 22,180円 | ★**−220円** | ★**99.0%** | **104/224** | 91.5% | +7.5pt |
| 馬連 | 1 | 22,400円 | 19,380円 | −3,020円 | 86.5% | 24/224 | 90.0% | −3.5pt |
| 三連複 | 1 | 22,400円 | 12,690円 | −9,710円 | 56.7% | 10/224 | 91.3% | −34.6pt |
| ⚠**三連単** | 2 | 44,800円 | 9,920円 | ⚠⚠**−34,880円** | ⚠⚠**22.1%** | ⚠**2/224** | 103.1% | ⚠**−81.0pt** |
★**4腕すべてで 112,000円 投じて 64,170円＝−47,830円**。

■ ★★**三連単が22%になった理由は計算できる**
　**期待される的中 224 × 2.63% = 5.9本 に対し、実際は ⚠2本**。
　★**期待通り5.9本当たり平均配当7,840円なら 46,200 ÷ 44,800 = 103%**。
　→ ⚠**「当たるはずの6本のうち4本が来なかった」だけ**。
　★**(200)の「上位1%のレースが払戻の81%」がそのまま現実に出た形**。
　**当たった2本は 7/12 の2,830円 と 7/18 の7,090円**。⚠**大穴は1本も入っていない**。

■ ★★言えること / 言えないこと
| ★言える | ⚠言えない |
|---|---|
| **三連単は月単位で±80pt動く**（実測22.1%） | **三連単の期待値が100%を割っている** |
| **複勝は月単位でも安定**（99.0%・的中104回） | **複勝のほうが良い**（11年では 91.5% < 103.1%） |
★**「超える想定で進める」なら、この22%の月に耐えられるかが実務上の第一条件**。
　⚠**(200)の20年シミュレーションで「悪い方5%は−74万円」と出したのは、こういう月が続く場合**。
