...
　★★**理由は交換の中身**（**同じ2点でも中身が違う**）:
| | 買い目 | 何を取って何を捨てるか |
|---|---|---|
| **A・2点** | `軸→紐1→紐2` / `軸→紐2→紐1` | ★**軸1着を確保し、紐2頭の2-3着の順序を両取り** |
| **F・2点** | `軸→紐1→紐2` / `紐1→軸→紐2` | ⚠**軸の1-2着を両取りする代わりに、★3着を紐2の1頭に決め打つ** |
　★**的中率は上がる（0.9%→1.2%）が、平均配当が 29,092→18,627円 に落ちて割に合わない**。
　★**3着を1頭に固定するコストが、軸の着順を緩めた利得を食い切っている**。

　★★**Gで壊滅した理由は、馬単Bが好調だったことと整合する**:
| | 必要な馬 | Gでの結果 |
|---|---|---|
| **馬単B**（紐→軸） | ★**2頭**（うち穴紐1頭） | ★**144.1%**・48年 |
| **三連単F**（紐→軸→紐） | ⚠**3頭**（うち★**穴紐2頭**） | ⚠**14.2%** |
　★**Gの紐は46.1倍・6.6番人気の穴**なので、★**穴紐を2頭当てる要求に変わった瞬間に当たらなくなる**。
...
　⚠**マスは98**。★**下端が0を超えたマスは1つも無い**（最良 P馬単B5点の −7.7）。
　★**現行の複勝1点は542年**。⚠**買うかどうかは利用者が決める**。
