...
| 回数 | ★**最良の収集時刻** | ★**またぎ** | カバー率 | 人気1一致 | 平均変化 | 対数相関 |
|---|---|---|---|---|---|---|
| **1回** | ★**09:30** | **8.9%** | 99.4% | 72.8% | 38.6% | 0.9479 |
| **2回** | ★**09:30 / 11:30** | **7.7%** | 99.4% | 72.8% | 37.3% | 0.9537 |
| **3回** | ★**09:30 / 11:30 / 14:30** | **7.0%** | 99.4% | 74.4% | 35.5% | 0.9557 |
| **4回** | **09:30 / 11:30 / 14:00 / 16:00** | **6.7%** | 99.4% | 75.6% | 34.1% | 0.9568 |
| *(参考)* **毎レース締切直前** | ⚠**現実的でない** | ★**0.9%** | — | 98.3% | 4.0% | 0.9979 |
